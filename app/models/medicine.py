...
class Medicine(models.Model):
    ...
    etc_otc_code = fields.CharField(max_length=10, null=True)
    chart = fields.TextField(null=True)
    print_front = fields.CharField(max_length=100, null=True)
    print_back = fields.CharField(max_length=100, null=True)
    line_front = fields.CharField(max_length=100, null=True)
    line_back = fields.CharField(max_length=100, null=True)
