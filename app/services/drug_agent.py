...
def _keyword_search(query: str, index_name: str, top_k: int = 5) -> list[dict]:
    ...
    q = query.strip()
    for suffix in ["성분이 뭐야?", "성분이 뭐야", "성분이", "성분 알려줘",
                   "효능이 뭐야", "부작용이 뭐야", "뭐야?", "뭐야",
                   "알려줘", "어떤 약", "어떤약"]:
        q = q.replace(suffix, " ")
...
def lookup_adverse(ingredient: str) -> str:
    ...
    if matches:
        return json.dumps([{"성분명": m, **_adverse[m]} for m in matches[:3]],
                          ensure_ascii=False)
...
TOOLS = [
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "검색할 약물명, 증상, 또는 질문 내용"
                    },
                    "top_k": {
                        "type": "integer",
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "성분명, 약물 계열, 또는 안전 관련 질문"
                    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "query": {
                        "type": "string",
                        "description": "브랜드명, 성분명, 약효군, 또는 분류 관련 질문"
                    },
                    "top_k": {"type": "integer", "default": 5}
                },
                "required": ["query"]
    ...
    },
    {
        ...
        "function": {
            "name": "lookup_adverse",
            "description": (
                "이상사례보고 데이터에서 성분명으로 코드를 조회합니다. "
                "성분명 exact match 또는 부분 매칭을 지원합니다."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "ingredient": {
                        "type": "string",
                        "description": "한글 성분명 (예: 아세트아미노펜, 이부프로펜)"
                    }
                },
                "required": ["ingredient"]
            }
